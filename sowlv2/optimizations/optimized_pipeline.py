...
from sowlv2.data.config import (
    PipelineBaseData, PipelineConfig, SingleDetectionInput, 
    MergedOverlayItem
)
from sowlv2.models import OWLV2Wrapper, SAM2Wrapper
from sowlv2.utils.pipeline_utils import DEFAULT_PALETTE, get_prompt_color, CUDA
...
class OptimizedSOWLv2Pipeline(SOWLv2Pipeline):
    ...
    def process_image(self, image_path: str, prompt: Union[str, List[str]], output_dir: str):
        ...
        for idx, (det_detail, mask) in enumerate(segmentation_results):
            ...
            # Overlay path
            from sowlv2.utils.pipeline_utils import create_overlay
